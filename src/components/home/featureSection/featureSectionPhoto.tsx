  ...
  return (
    <div className="flex  justify-center items-center md:justify-between flex-col md:flex-row w-full h-[627px]  gap-6 p-12">
      ...
      <div className="w-[auto] h-auto">
        <div className="relative  flex  justify-center  flex-row md:flex-col h-[280px] w-[343px] md:h-[627px] md:w-[766px]  ">
          <div className="absolute right-0 top-0 w-[248px] h-[248px] md:w-[570px] md:h-[570px]">
            <Image
          ...
          <div className=" absolute left-0 bottom-0 w-[146px] h-[177px] md:w-[337px] md:h-[408px]">
            <Image
